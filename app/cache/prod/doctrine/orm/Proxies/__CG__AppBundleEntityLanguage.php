...
class Language extends \AppBundle\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Language' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Language' . "\0" . 'groups', '' . "\0" . 'AppBundle\\Entity\\Language' . "\0" . 'enabled', '' . "\0" . 'AppBundle\\Entity\\Language' . "\0" . 'created_at', '' . "\0" . 'AppBundle\\Entity\\Language' . "\0" . 'updated_at');
        }
