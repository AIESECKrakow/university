 ...
 */
class Level extends \AppBundle\Entity\Level implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Level' . "\0" . 'level', '' . "\0" . 'AppBundle\\Entity\\Level' . "\0" . 'groups', '' . "\0" . 'AppBundle\\Entity\\Level' . "\0" . 'enabled', '' . "\0" . 'AppBundle\\Entity\\Level' . "\0" . 'created_at', '' . "\0" . 'AppBundle\\Entity\\Level' . "\0" . 'updated_at');
        }
